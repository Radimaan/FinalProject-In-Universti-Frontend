...
const ProductItem = () => {
  return (
    <div className="ProductItem rounded-2xl overflow-hidden border-[1px]  border-[rgba(0,0,0,0.1)] flex flex-row items-center transition-all duration-300 shadow-lg">
      <div className="ImageWaper w-[25%] h-[220px] overflow-hidden relative group/min">
      ...
      <div className="info p-3 bg-[#fff] w-[75%] px-10  ">
        <h6 className="!text-[15px]"><Link className="link transition-all !capitalize" to={'/'}>Soylent Green</Link></h6>
        <h3 className=" text-[18px]  my-2 font-[550] leading-[18px] text-[#000]">
          <Link className="link transition-all" to={'/'}>
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. </Link> </h3>

            <p className="text-[14px] mb-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate excepturi tenetur, nostrum quas deleniti ut sed dolorem soluta perspiciatis ratione </p>

        <Rating name="size-small" defaultValue={4}  readOnly />


        <div className="flex items-center gap-8">
          <span className="OldPrice line-through text-gray-500 text-[20px] font-[500]">$23.00</span>
          <span className="NewPrice text-[#ff5252] text-[20px] font-[600]">$20.99</span>
        </div>
        <div className="flex gap-4 m-auto">
          <Button className="btn-org gap-2"><MdOutlineShoppingCart className="text-[20px]"/> Add To Cart</Button>
          <Button className="!border !border-[#ff5252] p-[5px 15px] !text-black !mt-[10px] "> <RiRobot3Line className="text-[30px] !bg-transparent"/></Button>
        </div>
